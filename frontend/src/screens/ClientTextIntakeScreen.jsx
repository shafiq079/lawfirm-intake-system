...
const ClientTextIntakeScreen = ({ initialData }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <h1 className="text-3xl font-bold text-color-text mb-6">Client Text Intake</h1>
        ...
        >
          {({ isSubmitting, values }) => (
            <Form className="space-y-4">
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium text-color-text">Full Name</label>
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-color-text">Email</label>
              ...
              <div>
                ...
                <ErrorMessage name="phoneNumber" component="div" className="text-color-error text-xs mt-1" />
              </div>

              <div>
                <label htmlFor="serviceType" className="block text-sm font-medium text-color-text">Service Type</label>
                ...
                <ErrorMessage name="serviceType" component="div" className="text-color-error text-xs mt-1" />
              </div>

              {values.serviceType === 'immigration' && (
                <div>
                  <label htmlFor="visaType" className="block text-sm font-medium text-color-text">Visa Type</label>
                  ...
                  <ErrorMessage name="visaType" component="div" className="text-color-error text-xs mt-1" />
                </div>
              )}

              {values.serviceType === 'criminal' && (
                <div>
                  <label htmlFor="caseNumber" className="block text-sm font-medium text-color-text">Case Number (if applicable)</label>
                  ...
                  <ErrorMessage name="caseNumber" component="div" className="text-color-error text-xs mt-1" />
                </div>
              )}

              <div>
                <label htmlFor="description" className="block text-sm font-medium text-color-text">Description of Needs</label>
                ...
                <ErrorMessage name="description" component="div" className="text-color-error text-xs mt-1" />
              </div>

              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-color-accent hover:bg-color-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-color-accent"
              >
                Submit
              </button>
            </Form>
